...
import com.example.baseprojectflamingo.databinding.ActivityManageExpectedIncomeBinding
import com.example.baseprojectflamingo.ui.screen.manage_income.real.RealIncomeViewPager

class ManageExpectedIncomeActivity :
    BaseActivity<ActivityManageExpectedIncomeBinding>(R.layout.activity_manage_expected_income) {

    private lateinit var vpgAdapter: ExpectedViewPager
    ...
    private fun initVpg() = binding.layoutContainer.apply {
        vpgAdapter = ExpectedViewPager(this@ManageExpectedIncomeActivity)
